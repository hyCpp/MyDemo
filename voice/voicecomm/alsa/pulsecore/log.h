...
typedef enum pa_log_level {
    ...
    PA_LOG_VERBOSE= 5,    /* Verbose messages */
    PA_LOG_LEVEL_MAX
} pa_log_level_t;
...
#define pa_log_verbose(...)  pa_log_level_meta(PA_LOG_VERBOSE,  __FILE__, __LINE__, __func__, __VA_ARGS__)
...
LOG_FUNC(verbose, PA_LOG_VERBOSE)
