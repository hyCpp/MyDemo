...
#ifndef ALEXA_CLIENT_SDK_KWD_SPHINX_INCLUDE_KWD_SPHINX_KEY_WORD_DETECTOR_H_
#define ALEXA_CLIENT_SDK_KWD_SPHINX_INCLUDE_KWD_SPHINX_KEY_WORD_DETECTOR_H_
...
//#include "snowboy-detect.h"  del by zpt

namespace alexaClientSDK {
namespace kwd {

class SphinxKeyWordDetector : public AbstractKeywordDetector {
public:

    /**
     * Creates a @c SphinxKeyWordDetector.
     *
     ...
     * @return A new @c SphinxKeyWordDetector, or @c nullptr if the operation failed.
     * @see https://github.com/Kitt-AI/snowboy for more information regarding @c audioGain and @c applyFrontEnd.
     */
    static std::unique_ptr<SphinxKeyWordDetector> create(
     ...
     * Destructor.
     */
    ~SphinxKeyWordDetector() override;
...
private:
     ...
     * called once with each new @c SphinxKeyWordDetector.
     *
     * @param audioFormat The format of the audio data located within the stream.
     ...
     */
    bool isAudioFormatCompatibleWithSphinx(avsCommon::utils::AudioFormat audioFormat);
...
#endif  // ALEXA_CLIENT_SDK_KWD_SPHINX_INCLUDE_KWD_SPHINX_KEY_WORD_DETECTOR_H_
